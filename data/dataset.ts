...
export const dataset: ContentItem[] = [
  // Episodes
  {
    ...
    season: "Season 14",
    description: "Full collection of episodes from Season 14. Classic adventures with Nobita and his gadgets.",
  ...
  },
  {
    ...
    season: "Season 15",
    description: "Continuing the journey with Nobita, Gian, Suneo, and Shizuka in Season 15.",
    language: Language.TAMIL,
  ...
  },
  {
    ...
    season: "Season 16",
    description: "More gadget-filled mishaps and heartwarming stories in Season 16.",
    language: Language.TAMIL,
  ...
  },
  {
    ...
    season: "Season 17",
    description: "Exciting new episodes from Season 17 featuring unique 22nd-century gadgets.",
    language: Language.TAMIL,
  ...
  },
  {
    ...
    season: "Season 18",
    description: "The misadventures of Nobita continue in the 18th season of the series.",
    language: Language.TAMIL,
  ...
  },
  {
    ...
    season: "Season 19",
    description: "Recent episodes from Season 19, bringing fresh stories to the classic formula.",
    language: Language.TAMIL,
  ...
  // Movies
  {
    ...
    description: "Nobita and his friends travel to a land of bird-people and help them defend their home.",
    language: Language.TAMIL,
  ...
  },
  {
    ...
    description: "A space-faring adventure where the gang gets lost in the cosmos and meets alien civilizations.",
    language: Language.TAMIL,
  ...
  },
  {
    ...
    description: "The world becomes a land of magic where Nobita and friends must stop an ancient demon.",
    language: Language.TAMIL,
  ...
  },
  {
    ...
    description: "The gang visits a planet inhabited by talking animals and helps them fight off invaders.",
    language: Language.TAMIL,
  ...
  },
  {
    ...
    description: "Nobita builds a kingdom in the clouds, but they soon discover a secret heavenly civilization.",
    language: Language.TAMIL,
    keywords: [
      "kingdom of clouds", 
      "sky", 
  ...
  },
  {
    ...
    description: "The group travels 70,000 years into the past to create their own prehistoric paradise.",
    language: Language.TAMIL,
  ...
  },
  {
    ...
    description: "A tiny alien prince seeks help from Nobita to save his planet from a military dictator.",
    language: Language.TAMIL,
  ...
  },
  {
    ...
    description: "Nobita finds a fossilized egg and hatches a dinosaur named Pi-suke.",
    language: Language.TAMIL,
  ...
  },
  {
    ...
    description: "Undersea adventures with a mermaid princess to protect the mermaid kingdom.",
    language: Language.TAMIL,
  ...
  },
  {
    ...
    description: "A mysterious hotel run by robots leads to a world where humans are enslaved by machines.",
    language: Language.TAMIL,
  ...
  },
  {
    ...
    description: "Nobita uses a gadget to create a miniature universe for his summer project.",
    language: Language.TAMIL,
  ...
  },
  {
    ...
    description: "Nobita and his father find an island full of extinct prehistoric creatures.",
    language: Language.TAMIL,
  ...
  },
  {
    ...
    description: "A stray dog named Peko leads the gang to a hidden canine kingdom in Africa.",
    language: Language.TAMIL,
  ...
  },
  {
    ...
    description: "Nobita wins a toy planet and uses a gadget to bring his toys to life.",
    language: Language.TAMIL,
  ...
  },
  {
    ...
    description: "The gang takes a ride on a high-tech train through space to a theme park planet.",
    language: Language.TAMIL,
  ...
  },
  {
    ...
    description: "Nobita discovers a portal to a distant planet where gravity is lower and he becomes a hero.",
    language: Language.TAMIL,
  ...
  },
  {
    ...
    description: "Doraemon's bell is stolen, leading the gang to a museum showcasing all future gadgets.",
    language: Language.TAMIL,
  ...
  },
  {
    ...
    description: "A camping trip in the ocean leads to the discovery of a sunken civilization and a threat from space.",
    language: Language.TAMIL,
  ...
  },
  {
    ...
    description: "Nobita's obsession with a video game leads him to the world of Journey to the West.",
    language: Language.TAMIL,
  ...
  },
  {
    ...
    description: "Nobita saves a stray dog and cat, creating a future city for animals in the past.",
    language: Language.TAMIL,
  ...
  },
  {
    ...
    description: "Inspired by the classic novel, the gang sets sail to find hidden treasures.",
    language: Language.TAMIL,
  ...
  },
  {
    ...
    description: "A journey to a planet where robots and humans are at odds over their emotions.",
    language: Language.TAMIL,
  ...
  },
  {
    ...
    description: "Entering the world of the Arabian Nights storybook to save Shizuka.",
    language: Language.TAMIL,
  ...
  },
  {
    ...
    description: "Nobita befriends a wind creature and helps a tribe of wind-users against an evil force.",
    language: Language.TAMIL,
  ...
  },
  {
    ...
    description: "Doraemon uses a badge to create a world on the moon where they meet mysterious beings.",
    language: Language.TAMIL,
  ...
  },
  {
    ...
    description: "Searching for dinosaurs in the deep caves of the Earth leads to an underground world.",
    language: Language.TAMIL,
  ...
  },
  {
    ...
    description: "Nobita switches places with a prince in an ancient sun-worshipping civilization.",
    language: Language.TAMIL,
  ...
  },
  {
    ...
    description: "Pirates and prehistoric animals collide in this tropical island adventure.",
    language: Language.TAMIL,
  ...
  },
  {
    ...
    description: "An ice-bound mystery leads the gang to an ancient city beneath the South Pole.",
    language: Language.TAMIL,
  ...
  },
  {
    ...
    description: "Giant robots from another planet plan an invasion of Earth.",
    language: Language.TAMIL,
  ...
  },
  {
    ...
    description: "Nobita enters a dream world as a hero to defeat a dark lord.",
    language: Language.TAMIL,
  ...
  },
  {
    ...
    description: "Searching for a legendary paradise in the sky where everyone lives happily.",
    language: Language.TAMIL,
  ...
  },
  {
    ...
    description: "A musical adventure where Nobita and friends must save the world through the power of music.",
  ...
  // Specials
  {
    ...
    description: "A 3D computer-animated film that tells the story of Doraemon and Nobita's first encounter and final farewell.",
    language: Language.TAMIL,
  ...
  },
  {
    ...
    description: "Sequel exploring Nobita's future wedding and his relationship with his grandmother.",
    language: Language.NOT_IN_TAMIL,
  ...
  // Short Films
  {
    ...
    description: "The origin story detailing how Doraemon was made and how he became the blue cat we know.",
    language: Language.TAMIL,
